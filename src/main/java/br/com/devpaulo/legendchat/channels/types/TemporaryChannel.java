...
public final class TemporaryChannel implements Channel {
	...
	public TemporaryChannel(String name, String nick, String format, String meFormat, String color, boolean shortcut, boolean focus, double distance, boolean crossworlds, int delay, double cost, boolean show_cost_msg, Player leader, boolean mod_can_kick, boolean mod_can_invite) {
		this.name = name;
		this.nick = nick;
		this.format = format;
		formatMe = meFormat;
